...
export declare namespace Federated {
     ...
     * @example
     * ```ts
     * import { ScriptManager, Script, Federated } from '@krn/repack/client';
     *
     ...
     * for example:
     * ```ts
     * import { ScriptManager, Federated } from '@krn/repack/client';
     *
     ...
     * is equivalent to:
     * ```ts
     * import { ScriptManager, Script } from '@krn/repack/client';
     *
     * ScriptManager.shared.addResolver(async (scriptId, caller) => {
     *   if (scriptId === 'app1') {
     *     return {
     ...
     * import { Federated } from '@krn/repack/client';
     *
