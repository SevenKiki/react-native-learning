...
export function request(requestParams) {
    return new Promise((resolve, reject) => {
        ...
        if (typeof NativeModules.KSURCTNetworkInterface.request !== 'function') {
            reject(new Error('NativeModules.KSURCTNetworkInterface.request not function'));
        }
        NativeModules.KSURCTNetworkInterface.request(requestParams)
            .then((res) => {
            let resObj = res;
