...
import { ELiveScene, ELiveType, ELoggerType, EMicChatType, } from './interface';
import { ELiveSocketMessageType } from './messageType';
import { subscribeSocketMessage, unsubscribeSocketMessage, } from './socketMessage';
 ...
 */
export function enableDismissTouchOutside(params) {
 ...
 * @param params
 */
export function fetchResourcePath(params) {
 ...
 * 支持版本: 9.8.50+ </br>
 */
export function getLiveSceneInfo() {
 ...
 * @param params
 */
export function navigateToH5(params) {
 ...
 * 支持版本: 9.8.50+ </br>
 */
export function providePhoneInfo() {
 ...
 */
export function notifySendGiftSuccessV2(params) {
 ...
 * 支持版本: 8.3.60+ </br>
 */
export function openCustomH5(params) {
 ...
 * @param params
 */
export function openNonImmersiveH5(params) {
 ...
 * 支持版本: 8.0.40+ </br>
 */
export function getLiveRoomInfo() {
 ...
 * 支持版本: 7.7.30+ </br>
 */
export function provideTreasureBoxParams(params) {
 ...
 * 支持版本: 7.7.20+ </br>
 */
export function injectCache(params) {
 ...
 * @param params
 */
export function provideCache(params) {
 ...
 * @param params
 */
export function openLiveProfileCard(params) {
 ...
 * @param params
 */
export function mockEffectInfo(params) {
 ...
 * 支持版本: 10.4.40+ </br>
 */
export function invitePkOneMoreGame(params) {
 ...
 * 支持版本: 10.4.40+ </br>
 */
export function acceptPkOneMoreGame(params) {
 ...
 * 支持版本: 10.4.40+ </br>
 */
export function rejectPkOneMoreGame(params) {
 ...
 * 支持版本：9.10.30+ </br>
 */
export function batchFetchResourcePath(resInfoList) {
    return liveRnBridgeExecute('batchFetchResourcePath', { resInfoList });
}
export { subscribeSocketMessage, unsubscribeSocketMessage, ELiveType, ELiveScene, EMicChatType, ELoggerType, ELiveSocketMessageType, };
