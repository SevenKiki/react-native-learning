 ...
 * PK、视频连线、连麦属于
 */
export declare enum ELiveScene {
    DEFAULT = 0,
    PK = 1,
    VIDEO_CHAT = 2,
    MIC_CHAT = 3
 ...
 * 连麦类型
 */
export declare enum EMicChatType {
    VOICE = 1,
    VIDEO = 2
}
...
export declare const enum ELogTaskEventParams {
    UNKNOWN = 0,
    START = 1,
    RETRY = 2,
    PAUSE = 3,
