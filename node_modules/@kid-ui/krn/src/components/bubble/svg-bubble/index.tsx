...
import { Placement } from '../custom-bubble';
import { Shadow } from '@kds/react-native-shadow-2';

export interface SvgBubbleProps {
  style?: StyleProp<ViewStyle>;
  width?: number; //气泡宽
  height?: number; //气泡高
  placement?: Placement; //气泡方位
  borderRadius?: number; //气泡圆角
  color?: string; // 气泡颜色
  withTriangle?: boolean; //是否显示三角箭头
  triangleWidth?: number; //三角箭头宽
  triangleHeight?: number; //三角箭头高
  triangleColor?: string; //三角箭头颜色
  triangleBorderWidth?: number; //三角箭头边框宽度
  triangleBorderColor?: string; //三角箭头边框颜色
  offsetX?: number; //三角箭头偏移
}
...
export const SvgBubble: React.FC<SvgBubbleProps> = (props: SvgBubbleProps) => {
  const {
    style,
    width = 120,
    height = 40,
