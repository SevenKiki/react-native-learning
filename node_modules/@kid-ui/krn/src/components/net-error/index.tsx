...
export type NetErrorProps = {
  title?: string;
  buttonBgColor?: ThemeValue<string>;
  linkColor?: ThemeValue<string>;
  descTextColor?: ThemeValue<string>;
  buttonCornerRadius?: number;
  buttonBorderWidth?: number;
  iconColor?: ThemeValue<string>;
  onPress?: () => void;
  onPressSolution?: () => void;
  emptyStyle?: string;
  buttonBorderColor?: ThemeValue<string>;
  buttonTextColor?: ThemeValue<string>;
};

const NetError: React.FC<NetErrorProps> = (props) => {
  ...
  return (
    <View style={styles.wrap}>
      ...
      {!buttonShow ? null : (
        <KidButton
          kid={'style_button_medium_orange_bg'}
      ...
      {!resolveShow ? null : (
        <TouchableOpacity
          onPress={onPressSolution}
          hitSlop={{ left: rem(20), right: rem(20), top: rem(9), bottom: rem(20) }}
        >
          <Text
            style={[
              {
...
NetError.defaultProps = {
  ...
  onPress: () => { },
  onPressSolution: () => {
    NativeModules.KIDBridge?.showNetworkSolutionAlert?.();
  },
};
