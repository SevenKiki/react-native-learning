...
import { StyleSheet, View, Animated, PanResponder, StyleProp, ViewStyle } from 'react-native';
...
import { ThemeValue, useThemeValue } from '../../theme/useThemeValue';
...
interface RangeSliderProps {
  ...
  trackColor?: ThemeValue<string>;
  activeTrackColor?: ThemeValue<string>;
  trackStyle?: StyleProp<ViewStyle>;
  activeTrackStyle?: StyleProp<ViewStyle>;
  minimumDotStyle?: StyleProp<ViewStyle>;
  maximumDotStyle?: StyleProp<ViewStyle>;
  renderMinimumDot?: (style: ViewStyle) => JSX.Element;
  renderMaximumDot?: (style: ViewStyle) => JSX.Element;
}
          ...
          endX - beginX >= 0 && (
            <>
              <ActiveLine
                ...
                containerStyle={trackStyle}
                barStyle={activeTrackStyle}
              />
              ...
              <SliderDot
                ...
                style={minimumDotStyle}
                render={renderMinimumDot}
              />
              <SliderDot
                size={dotSize}
                translateX={xSlideEnd}
                panResponder={panResponderEnd}
                style={[styles.dotAbsolute, maximumDotStyle, { zIndex: zIndex, elevation: zIndex }]}
                render={renderMaximumDot}
              />
            </>
          )
        }
