...
//自定义节流函数
export function throttle(func: Function, wait: number = 0, options?: { leading: boolean } | any) {
  let context: any, args: any, timeout: any, result: any;
  let previous = 0;
 ...
 * @return {*}
 */
export const transformToDebounce = (func: (...any: any) => any, delay: number) => {
 ...
 * @return {*}
 */
export const transformToThrottle = (func: (...any: any) => any, delay: number) => {
  return throttle(func, delay);
}

export const transformOnPress = (func: (...any: any) => any, debounceDuration?: number, throttleDuration?: number) => {
