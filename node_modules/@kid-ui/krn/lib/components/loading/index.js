...
export class KidLoading extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        let path = (<>
                ...
                <AnimatePath 
        // @ts-ignore
        strokeDasharray="160" strokeLinecap="round" d="M40 40l8.201-8.201c4.53-4.53 11.873-4.53 16.402 0A11.598 11.598 0 0 1 68 40c0 6.405-5.193 11.598-11.598 11.598a11.598 11.598 0 0 1-8.201-3.397L40 40l-8.201-8.201c-4.53-4.53-11.873-4.53-16.402 0A11.598 11.598 0 0 0 12 40c0 6.405 5.193 11.598 11.598 11.598 3.076 0 6.026-1.222 8.201-3.397L40 40z" stroke={type} strokeWidth="7" fill="none" fillRule="nonzero" strokeDashoffset={this.offset}/>
            </>);
