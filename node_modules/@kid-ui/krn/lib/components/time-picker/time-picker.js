...
export class TimePicker extends React.Component {
    constructor(props) {
        ...
        this.state = Object.assign({}, this.init(props));
    }
    init(props) {
        ...
        if (valueArray && valueArray.length) {
            valueArray.forEach((valueItem, valueIndex) => {
                ...
                if (!tag) {
                    throw TypeError(`value 参数${valueIndex === 0
                        ? '时'
                        : valueIndex === 1
                            ? '分'
                            : '秒'}字段 ${valueItem} 无效`);
    ...
    render() {
        ...
        return (<ScrollPicker {...this.props} value={value} list={list} onChange={this.handleChange}/>);
    }
}
TimePicker.defaultProps = Object.assign(Object.assign({}, ScrollPicker.defaultProps), { hourStep: 1, minuteStep: 1, secondStep: 1 });
