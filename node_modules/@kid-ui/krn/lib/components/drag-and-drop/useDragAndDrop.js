...
export function useDrop(context) {
...
export function useDrag(context) {
    const dndStore = useContext(DragAndDropRootContext);
    const dndContext = context !== null && context !== void 0 ? context : useContext(DropAreaContext);
    const contexts = useMemo(() => (Array.isArray(dndContext) ? dndContext : [dndContext]), [dndContext]);
...
export function useDndSubject(context) {
    const dndStore = useContext(DragAndDropRootContext);
