...
import { BaseRequestImpl } from '@locallife/base-request';
...
export class BizRequestImpl extends BaseRequestImpl {
  ...
  initInnerInterceptors(requestInnerInterceptors, responseInnerInterceptors, config) {
    ...
    !((_BizRequestImpl$defau4 = BizRequestImpl.defaultInterceptorParams) !== null && _BizRequestImpl$defau4 !== void 0 && _BizRequestImpl$defau4.disableLogTimeCost) && requestInnerInterceptors.push(new RequestTimeCostInterceptor());
    ...
    !((_BizRequestImpl$defau7 = BizRequestImpl.defaultInterceptorParams) !== null && _BizRequestImpl$defau7 !== void 0 && _BizRequestImpl$defau7.disableReportMonitorLog) && responseInnerInterceptors.unshift(new ResponseMonitorLogInterceptor());
    ...
    if (enableResponseBaseVerify) {
      responseInnerInterceptors.unshift(new ResponseBaseVerifyInterceptor());
    }

    !((_BizRequestImpl$defau9 = BizRequestImpl.defaultInterceptorParams) !== null && _BizRequestImpl$defau9 !== void 0 && _BizRequestImpl$defau9.disableLogTimeCost) && responseInnerInterceptors.unshift(new ResponseTimeCostInterceptor());
  }
