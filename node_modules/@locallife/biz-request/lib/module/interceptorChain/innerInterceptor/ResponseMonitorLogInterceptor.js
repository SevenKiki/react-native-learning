...
export default class ResponseMonitorLogInterceptor extends Interceptor {
  proceed() {
    return function (model) {
      ...
      LocalLifeRequestLogger.logRequest((_model$requestParams$ = (_model$requestParams = model.requestParams) === null || _model$requestParams === void 0 ? void 0 : _model$requestParams.url) !== null && _model$requestParams$ !== void 0 ? _model$requestParams$ : '', true, -1, '', {
        costTime
      });
