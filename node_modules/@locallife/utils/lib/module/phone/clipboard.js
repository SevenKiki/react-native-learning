...
export const setClipBoard = async function (text) {
  let toastContent = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '复制成功';

  try {
    await NativeModules.Kds.invoke('system', 'getNavigationBarHeight', JSON.stringify({
      text
    }));
