...
exports.LocalLifeKrnBaseLogger = void 0;
exports.default = LocalLifeKrnLogger;

var _log = require("@ks/weblogger/lib/log.krnbridge");
...
var _LocalLifeFmpLogger = _interopRequireDefault(require("../LocalLifeFmpLogger"));

var _LocalLifeBizLogger = require("../LocalLifeBizLogger");
...
class LocalLifeKrnBaseLogger extends _log.Weblog {
  /**
  ...
  constructor(options) {
    ...
    _defineProperty(this, "handleT2", _LocalLifeFmpLogger.default.handleT2);

    _defineProperty(this, "handleT3", _LocalLifeFmpLogger.default.handleT3);
    ...
    _LocalLifeInitLogger.default.initWithAppModel(appModel, this); // 取链接参数及PV参数
    ...
    _LocalLifeInitLogger.default.setBizInfo(pvEventOptions); // 自动上报PV


    this.pv(); // 自动上报T1 白屏时间

    _LocalLifeFmpLogger.default.handleT1(); // 榜单task所需打点事件
  ...
  pv() {
    ...
    _LocalLifeBizLogger.localLifeBizLogger.pageShow(option);
  } // 元素SHOW事件用这个
  ...
  show(_ref4) {
    ...
    _LocalLifeBizLogger.localLifeBizLogger.show(action, params, contentPackage, other);
  } // 点击事件用这个
  ...
  click(_ref5) {
    ...
    _LocalLifeBizLogger.localLifeBizLogger.click(action, params, contentPackage, other);
  }
...
exports.LocalLifeKrnBaseLogger = LocalLifeKrnBaseLogger;
let krnLogger;
/**
