...
function buildChain(requestInterceptors, requestInnerInterceptors, responseInnerInterceptors, responseInterceptors) {
  return [...requestInterceptors, ...requestInnerInterceptors, new RequestExecuteInterceptor(), ...responseInnerInterceptors, ...responseInterceptors];
}

export function start(requestInnerInterceptors, responseInnerInterceptors, config, params) {
