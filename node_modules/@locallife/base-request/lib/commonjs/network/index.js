...
async function execute(requestParam) {
  var _requestParam$method;

  // method 兜底
  requestParam.method = (_requestParam$method = requestParam.method) !== null && _requestParam$method !== void 0 ? _requestParam$method : _IRequestParam.RequestMethod.GET;
  setCommonParams(requestParam);
  console.log(`@locallife/base-request: start request params=${JSON.stringify(requestParam)}`);
  return await _reactNative.NativeModules.KSURCTNetworkInterface.request( // @ts-ignore
  requestParam);
}
