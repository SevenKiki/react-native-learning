...
// fixed属性需求新增：对外暴露_shadowViewRegistry（readonly）
@property (atomic, strong, readonly) NSMutableDictionary<NSNumber *, RCTShadowView *> *mShadowViewRegistry;

// fixed属性需求新增：对外暴露3个内部方法
- (void)_shadowViewDidReceiveUpdatedChildren:(RCTShadowView *)shadowView;
- (void)createView:(nonnull NSNumber *)reactTag
          viewName:(NSString *)viewName
           rootTag:(nonnull NSNumber *)rootTag
             props:(NSDictionary *)props;
- (void)manageChildren:(nonnull NSNumber *)containerTag
