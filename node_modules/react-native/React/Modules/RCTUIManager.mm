...
static void RCTTraverseViewNodesLRD(id<RCTComponent> view, void (^block)(id<RCTComponent>))
{
    if (view.reactTag) {
        for (id<RCTComponent> subview in view.reactSubviews) {
            RCTTraverseViewNodesLRD(subview, block);
        }
...
@implementation RCTUIManager
{
  ...
  // Keyed by viewName
  @protected NSMutableDictionary *_componentDataByName;
}
...
- (void)setBridge:(RCTBridge *)bridge
{
  ...
  _viewRegistry = [NSMutableDictionary new];
  _nativeIDRegistry = [NSMapTable strongToWeakObjectsMapTable];
  _mShadowViewRegistry = _shadowViewRegistry;
          ...
          fromRegistry:(NSMutableDictionary<NSNumber *, id<RCTComponent>> *)registry
{
  for (id<RCTComponent> child in children) {
      ...
      if (RCTKDSFixedEnabled()) {
          RCTTraverseViewNodesLRD(child, ^(id<RCTComponent> subview) {
              // 节点若包含移出的fixed节点，则批量删除移出的这些fixed节点
              [self removeAllFixedChildrenRecursive:subview shadowViewRegistry:registry];
              // virtualNode则删除关联fixed节点
              [self removeFixedChildRecursive:subview shadowViewRegistry:registry];
          });
      }
...
{
    if (RCTKDSFixedEnabled()) {
        reactTags = [self replaceFixedWithVirtualViewToContainer:containerTag
                                                       reactTags:reactTags
                                              shadowViewRegistry:_shadowViewRegistry];
    }
               ...
               registry:(NSMutableDictionary<NSNumber *, id<RCTComponent>> *)registry
{
  ...
  for (NSInteger index = 0, length = addAtIndices.count; index < length; index++) {
    id<RCTComponent> view = registry[addChildReactTags[index]];
      ...
      if (RCTKDSFixedEnabled()) {
          // 通过addChildReactTags增加的节点则替换成对应的空节点进行增加
          id<RCTComponent> virtualView = [self interceptFixedChildToRootView:view registry:_shadowViewRegistry];
          if (virtualView && virtualView != view) {
              view = virtualView;
          }
      }
...
@interface RCTUIManagerTurbo : RCTUIManager <NativeUIManagerSpec>

@end

@implementation RCTUIManagerTurbo
...
RCT_EXPORT_METHOD(onBatchComplete)
{
...
RCT_EXPORT_METHOD(configureNextLayoutAnimation:(NSDictionary *)config
                  ...
                  errorCallback:(__unused RCTResponseSenderBlock)errorCallback)
{
  [super configureNextLayoutAnimation:config
...
RCT_EXPORT_METHOD(dispatchViewManagerCommand:(nonnull NSNumber *)reactTag
                  ...
                  commandArgs:(NSArray<id> *)commandArgs)
{
  [super dispatchViewManagerCommand:reactTag
                          commandID:@(commandID)
                        commandArgs:commandArgs];
  
}

RCT_EXPORT_METHOD(dispatchViewManagerStringCommand:(nonnull NSNumber *)reactTag
...
RCT_EXPORT_METHOD(findSubviewIn:(nonnull NSNumber *)reactTag
                  point:(NSArray *)point
                  callback:(RCTResponseSenderBlock)callback)
{
  [super findSubviewIn:reactTag
               atPoint:CGPointMake([point.firstObject floatValue], [point.lastObject floatValue])
              callback:callback];
}

RCT_EXPORT_METHOD(focus:(nonnull NSNumber *)reactTag)
{
  [super focus:reactTag];
}

RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(lazilyLoadView:(NSString *)name)
{
  return [super lazilyLoadView:name];
}
...
RCT_EXPORT_METHOD(manageChildren:(nonnull NSNumber *)containerTag
                  ...
                  removeAtIndices:(NSArray<NSNumber *> *)removeAtIndices)
{
  [super manageChildren:containerTag
        moveFromIndices:moveFromIndices
          moveToIndices:moveToIndices
      addChildReactTags:addChildReactTags
           addAtIndices:addAtIndices
...
RCT_EXPORT_METHOD(measureInWindow:(nonnull NSNumber *)reactTag
                  callback:(RCTResponseSenderBlock)callback)
{
  [super measureInWindow:reactTag
                callback:callback];
}

RCT_EXPORT_METHOD(measureLayout:(nonnull NSNumber *)reactTag
                  ancestorReactTag:(nonnull NSNumber *)ancestorReactTag
                  errorCallback:(__unused RCTResponseSenderBlock)errorCallback
                  callback:(RCTResponseSenderBlock)callback)
{
  [super measureLayout:reactTag
            relativeTo:ancestorReactTag
         errorCallback:errorCallback
              callback:callback];
}
...
RCT_EXPORT_METHOD(measureLayoutRelativeToParent:(nonnull NSNumber *)reactTag
                  ...
                  callback:(RCTResponseSenderBlock)callback)
{
  [super measureLayoutRelativeToParent:reactTag
                         errorCallback:errorCallback
                              callback:callback];
}
...
RCT_EXPORT_METHOD(removeRootView:(nonnull NSNumber *)rootReactTag)
{
  [super removeRootView:rootReactTag];
}

RCT_EXPORT_METHOD(removeSubviewsFromContainerWithID:(double)containerID)
{
  [super removeSubviewsFromContainerWithID:@(containerID)];
}

RCT_EXPORT_METHOD(replaceExistingNonRootView:(nonnull NSNumber *)reactTag
                  newReactTag:(nonnull NSNumber *)newReactTag)
{
  [super replaceExistingNonRootView:reactTag
                           withView:newReactTag];
}

RCT_EXPORT_METHOD(setChildren:(nonnull NSNumber *)containerTag
                  reactTags:(NSArray<NSNumber *> *)reactTags)
{
  [super setChildren:containerTag
           reactTags:reactTags];
}
...
RCT_EXPORT_METHOD(setJSResponder:(nonnull NSNumber *)reactTag
                  blockNativeResponder:(__unused BOOL)blockNativeResponder)
{
  [super setJSResponder:reactTag
   blockNativeResponder:blockNativeResponder];
}

RCT_EXPORT_METHOD(updateView:(double)reactTag
                  viewName:(NSString *)viewName // not always reliable, use shadowView.viewName if available
                  props:(NSDictionary *)props)
{
  [super updateView:@(reactTag)
           viewName:viewName
              props:props];
}
...
RCT_EXPORT_METHOD(viewIsDescendantOf:(nonnull NSNumber *)reactTag
                  ...
                  callback:(RCTResponseSenderBlock)callback)
{
  [super viewIsDescendantOf:reactTag
                   ancestor:ancestorReactTag
                   callback:callback];
}
...
- (NSDictionary *)getDefaultEventTypes {
  return @{};
}
...
- (void)sendAccessibilityEvent:(NSNumber *)reactTag eventType:(double)eventType {
}
...
{
    return std::make_shared<facebook::react::NativeUIManagerSpecJSI>(params);
}
...
{
  Class cls = RCTTurboModuleEnabled() ? RCTUIManagerTurbo.class : RCTUIManager.class;
  return [self moduleForClass:cls];
}
