  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    if (!self->_contentHasAppeared) {
      ...
      [[NSNotificationCenter defaultCenter] postNotificationName:RCTContentDidAppearNotification
                                                        ...
                                                        userInfo:@{
                                                            RCTBridgeUniqueIdKey: @(self.bridge.parentBridge.uniqueID)
                                                        }];
    }
  });
}
...
- (void)setTouchHandlerProperty {
    _touchHandler.canBlockOtherGestures = _canBlockOtherGestures;
    _touchHandler.shouldRecognizeSimultaneously = _shouldRecognizeSimultaneously;
}
