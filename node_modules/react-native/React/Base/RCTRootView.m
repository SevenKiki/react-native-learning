...
NSString *const RCTRootViewWillRemoveFromWindowNotification = @"RCTRootViewWillRemoveFromWindowNotification";
...
- (void)setCanBlockOtherGestures:(BOOL)canBlockOtherGestures{
    if (canBlockOtherGestures != _canBlockOtherGestures) {
        _canBlockOtherGestures = canBlockOtherGestures;
        _contentView.canBlockOtherGestures = canBlockOtherGestures;
    }
}

- (void)setShouldRecognizeSimultaneously:(BOOL)shouldRecognizeSimultaneously {
    if (shouldRecognizeSimultaneously != _shouldRecognizeSimultaneously) {
        _shouldRecognizeSimultaneously = shouldRecognizeSimultaneously;
        _contentView.shouldRecognizeSimultaneously = shouldRecognizeSimultaneously;
    }
}
