...
NSString *const RCTBridgeSourceURLPathKey = @"sourceUrlPath";

static NSMutableArray<Class> *RCTModuleClasses;
static dispatch_queue_t RCTModuleClassesSyncQueue;
static int32_t RCTBridgeUniqueID = 0;
                   ...
                   launchOptions:(NSDictionary *)launchOptions
{
  if (self = [super init]) {
    ...
    _uniqueID = OSAtomicIncrement32(&RCTBridgeUniqueID);
    if (launchOptions[RCTBridgeSourceURLPathKey]) {
      _sourceUrlPath = launchOptions[RCTBridgeSourceURLPathKey];
    }
    [self setUp];
  }
  return self;
...
#pragma mark - For Category Override
- (id<RCTBridgeRedBoxProtocol>)redBox
{
  NSAssert(0, @"Shouldn't Invoke");
  return nil;
}

- (id<RCTBridgeDevSettingProtocol>)devSettings
{
  NSAssert(0, @"Shouldn't Invoke");
  return nil;
}
