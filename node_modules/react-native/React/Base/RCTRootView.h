...
extern NSString *const RCTRootViewWillRemoveFromWindowNotification;
...
/**
 * When set, gesture in RCTRootView will block all other gestures.
 *
 * The default value is NO.
 */
@property (nonatomic, assign) BOOL canBlockOtherGestures;

/**
 * Set to YES will allow simultaneous recognition，should set canBlockOtherGestures to YES first.
 *
 * The default value is NO.
 */
