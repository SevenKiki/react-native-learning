...
@property (nonatomic, assign) BOOL isFixedNode;
@property (nonatomic, assign) BOOL isBindingVirtualNode;
@property (nonatomic, strong) NSNumber *originalParentTag;
@property (nonatomic, strong) NSMutableArray<NSNumber *> *moveOutFixedChildrenTags;
// 其子节点为fixed，且被移到rootView后，需要在此记录该fixed的reactTag
- (void)addMovedOutFixedChildTag:(NSNumber *)tag;
// 获取所有为fixed属性的子节点reactTag
