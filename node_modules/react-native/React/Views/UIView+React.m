...
- (void)removeReactSubview:(UIView *)subview
{
  ...
  [subview removeFromSuperview];
    if (subview.removeReactSubviewBlock) {
        subview.removeReactSubviewBlock(self);
    }
}
...
- (void)didUpdateReactSubviews
{
  for (UIView *subview in self.reactSubviews) {
      if (subview.updateReactSubviewBlock) {
          subview.updateReactSubviewBlock(self);
          continue;
      }
...
- (void (^)(UIView *))updateReactSubviewBlock
{
    return objc_getAssociatedObject(self, @selector(updateReactSubviewBlock));
}

- (void)setUpdateReactSubviewBlock:(void (^)(UIView *))updateReactSubviewBlock
{
    objc_setAssociatedObject(self, @selector(updateReactSubviewBlock), updateReactSubviewBlock, OBJC_ASSOCIATION_COPY_NONATOMIC);
}

- (void (^)(UIView *))removeReactSubviewBlock
{
    return objc_getAssociatedObject(self, @selector(removeReactSubviewBlock));
}

- (void)setRemoveReactSubviewBlock:(void (^)(UIView *))removeReactSubviewBlock
{
    objc_setAssociatedObject(self, @selector(removeReactSubviewBlock), removeReactSubviewBlock, OBJC_ASSOCIATION_COPY_NONATOMIC);
}
