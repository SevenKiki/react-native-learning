...
public class NativeViewHierarchyManager {
  ...
  protected final SparseArray<View> mTagsToViews;
  protected final SparseArray<ViewManager> mTagsToViewManagers;
  protected final SparseBooleanArray mRootTags;
  private final ViewManagerRegistry mViewManagers;
  private final JSResponderHandler mJSResponderHandler = new JSResponderHandler();
  private final RootViewManager mRootViewManager;
  protected final LayoutAnimationController mLayoutAnimator = new LayoutAnimationController();
  protected final SparseArray<SparseIntArray> mTagsToPendingIndicesToDelete = new SparseArray<>();
  private final int[] mDroppedViewArray = new int[100];
  private final RectF mBoundingBox = new RectF();

  protected boolean mLayoutAnimationEnabled;
  ...
  public final synchronized View resolveView(int tag) {
    ...
    if (view == null) {
     FLog.e(TAG, "Trying to resolve view with tag " + tag + " which doesn't exist");
    }
    return view;
  }
  ...
  public synchronized void crossLevelMoveChild(int reactTag, int destParentTag, int index) {
    View sourceView = mTagsToViews.get(reactTag);
    ViewGroup destParentView = (ViewGroup) mTagsToViews.get(destParentTag);
    if (sourceView == null || destParentView == null) {
      return;
    }
    ...
    int removeIndex = sourceParent.indexOfChild(sourceView);
    sourceParent.removeViewAt(removeIndex);
    destParentView.addView(sourceView, index);
  }

  protected static String constructManageChildrenErrorMessage(
   ...
   */
  protected int normalizeIndex(int index, SparseIntArray pendingIndices) {
   ...
   * async view deletion)
   */
  protected SparseIntArray getOrCreatePendingIndicesToDelete(int tag) {
  ...
  protected boolean arrayContains(@Nullable int[] array, int ele) {
    if (array == null) {
      return false;
    }
  ...
  public synchronized void setChildren(int tag, ReadableArray childrenTags) {
    ...
    View view = mTagsToViews.get(tag);
    if (view == null) return;
    ViewGroup viewToManage = (ViewGroup) view;
  ...
  protected void cacheDroppedTag(int tag) {
  ...
  public synchronized void measureInWindow(int tag, int[] outputBuffer) {
    ...
    View v = mTagsToViews.get(tag);
    if (v == null) {
      FLog.e(TAG, "No native view for " + tag + " currently exists");
      return;
    }
  ...
  public synchronized void dispatchCommand(
    ...
    View view = mTagsToViews.get(reactTag);
    if (view == null) {
      FLog.e(TAG, "Trying to send command to a non-existing view " + "with tag " + reactTag);
      return;
    }
