...
public class ReactShadowNodeImpl implements ReactShadowNode<ReactShadowNodeImpl> {
  ...
  // position:fixed
  private int mOriginalParentTag = 0;
  private JavaOnlyArray mMoveOutFixedChildrenTags = null;
  private boolean mIsBindingVirtualNode = false;
  ...
  @Override
  public void setOriginalParentTag(int tag) {
    mOriginalParentTag = tag;
  }

  @Override
  public int getOriginalParentTag() {
    return mOriginalParentTag;
  }

  @Override
  public void setBindingVirtualNode(boolean isBindingVirtualNode) {
    mIsBindingVirtualNode = isBindingVirtualNode;
  }

  @Override
  public boolean isBindingVirtualNode() {
    return mIsBindingVirtualNode;
  }

  @Override
  public void setMovedOutFixedChildTag(int tag) {
    if (mMoveOutFixedChildrenTags == null) {
      mMoveOutFixedChildrenTags = new JavaOnlyArray();
    }
    mMoveOutFixedChildrenTags.pushInt(tag);
  }

  @Override
  public void resetMovedOutFixedChildTags(JavaOnlyArray tags) {
    mMoveOutFixedChildrenTags = tags;
  }

  @Override
  public JavaOnlyArray getMovedOutFixedChildTags() {
    return mMoveOutFixedChildrenTags;
  }
