...
public enum ReactMarkerConstants {
  ...
  moduleJSRequireBeginningFail,
  moduleJSRequireEndingStart,
  moduleJSRequireEndingEnd,
  moduleJSRequireEndingFail,
  syncMethodCallStart,
  syncMethodCallArgConversionStart,
  syncMethodCallArgConversionEnd,
  syncMethodCallExecutionStart,
  syncMethodCallExecutionEnd,
  syncMethodCallReturnConversionStart,
  syncMethodCallReturnConversionEnd,
  syncMethodCallEnd,
  syncMethodCallFail,
  asyncMethodCallStart,
  asyncMethodCallArgConversionStart,
  asyncMethodCallArgConversionEnd,
  asyncMethodCallDispatch,
  asyncMethodCallEnd,
  asyncMethodCallFail,
  ...
  registerModulesStart,
  registerModulesEnd,
  LOAD_FIRST_PAGE_START,
  LOAD_FIRST_PAGE_END,
