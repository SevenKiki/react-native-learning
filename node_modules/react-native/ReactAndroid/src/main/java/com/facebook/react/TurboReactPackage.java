...
public abstract class TurboReactPackage implements ReactPackage, LazyViewManagerPackage {
  ...
  @Nullable
  @Override
  public ViewManager createViewManager(@NonNull ReactApplicationContext reactContext, @NonNull String name) {
    List<ModuleSpec> viewManagerModuleSpecs = getViewManagers(reactContext);
    if (viewManagerModuleSpecs == null || viewManagerModuleSpecs.isEmpty()) {
      return null;
    }
    ...
    for (ModuleSpec moduleSpec : viewManagerModuleSpecs) {
      if (moduleSpec.getName() != null && moduleSpec.getName().equals(name)) {
