...
public class ReactFeatureFlags {
  ...
  public static boolean enableBackgroundDecorView = true;

  public static boolean enablePositionFixed = true;

  public static boolean useCodeCache = true;

  public static boolean enableReactImageWarning = false;

  public static boolean enablePropsGetter = true;

  /**
   * 根节点移除了，子节点按理说应该也要移除，这里加个开关
   */
  public static boolean enableRemoveChildShadowNode = true;

  public static boolean enableResizeMethod = true;

  public static boolean tempFixTurboModuleCrash = true;

  public static boolean tempFixSvgLeak = true;

  public static AtomicBoolean enableScrollEventListener = new AtomicBoolean(false);

  /**
   * 是否启用DevSupportManagerImpl中摇一摇监听器
   */
  public static boolean enableShakeListener = true;

  public static boolean enableGetConstantsOpt = false;
  ...
  public static boolean enableTurboModuleProfile = false;

  public static boolean enableUiManagerOnTurboModule = false;

  public static boolean suppressOnHostPauseIfDestroyed = true;

  public static boolean suppressSetSourceUrlWhenLoadScript = false;

  public static boolean enableBlobModuleContextCleanupFix = true;
}
