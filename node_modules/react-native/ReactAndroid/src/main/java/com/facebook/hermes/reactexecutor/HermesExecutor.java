...
public class HermesExecutor extends JavaScriptExecutor {
  ...
  HermesExecutor(@Nullable RuntimeConfig config) {
    super(
        config == null
            ...
            : initHybrid(config.heapSizeMB, config.es6Symbol, config.bytecodeWarmupPercent, config.es6Proxy));
  }
  ...
  private static native HybridData initHybrid(
      long heapSizeMB, boolean es6Symbol, int bytecodeWarmupPercent, boolean es6Proxy);
}
