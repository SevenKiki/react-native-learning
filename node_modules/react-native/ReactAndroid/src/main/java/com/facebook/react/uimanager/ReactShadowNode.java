...
public interface ReactShadowNode<T extends ReactShadowNode> {
  ...
  void setOriginalParentTag(int tag);

  int getOriginalParentTag();

  void setBindingVirtualNode(boolean isBindingVirtualNode);

  boolean isBindingVirtualNode();

  void resetMovedOutFixedChildTags(JavaOnlyArray tags);

  void setMovedOutFixedChildTag(int tag);
