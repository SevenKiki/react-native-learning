...
public final class JavaScriptModuleRegistry {
  ...
  public synchronized <T extends JavaScriptModule> T getJavaScriptModule(
    ...
    JavaScriptModule interfaceProxy = null;
    if (moduleInterface == TransientEventEmitter.class) {
      interfaceProxy = new TransientEventEmitter(instance, moduleInterface);
    } else {
      interfaceProxy = (JavaScriptModule)
