...
public class UIViewOperationQueue {
  ...
  private final class CrossLevelMoveChildOperation extends ViewOperation {
    private final int mDestTag;
    private final int mIndex;

    public CrossLevelMoveChildOperation(int sourceTag, int destTag, int index) {
      super(sourceTag);
      mDestTag = destTag;
      mIndex = index;
    }
    ...
    @Override
    public void execute() {
      mNativeViewHierarchyManager.crossLevelMoveChild(mTag, mDestTag, mIndex);
    }
  }
  ...
  public void crossLevelMoveChild(int sourceTag, int destTag, int index) {
    mOperations.add(new CrossLevelMoveChildOperation(sourceTag, destTag, index));
  }
