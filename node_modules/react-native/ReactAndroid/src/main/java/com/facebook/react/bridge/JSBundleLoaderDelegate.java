...
public interface JSBundleLoaderDelegate {
   ...
   */
  void loadScriptFromAssets(AssetManager assetManager, String assetURL, String sourceURL, boolean loadSynchronously);

  void loadScriptFromAssets(AssetManager assetManager, String assetURL, boolean loadSynchronously, String cacheKey);
  ...
  void loadScriptFromFile(String fileName, String sourceURL, boolean loadSynchronously, String cacheKey);
