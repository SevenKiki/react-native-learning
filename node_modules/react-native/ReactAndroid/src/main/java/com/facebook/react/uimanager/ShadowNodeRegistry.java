...
public class ShadowNodeRegistry {
  ...
  public void removeRootNode(int tag) {
    ...
    if (ReactFeatureFlags.enableRemoveChildShadowNode) {
      ReactShadowNode reactShadowNode = mTagsToCSSNodes.get(tag);
  ...
  private void removeShadowNodeRecursive(ReactShadowNode nodeToRemove) {
    ...
    mTagsToCSSNodes.remove(nodeToRemove.getReactTag());
