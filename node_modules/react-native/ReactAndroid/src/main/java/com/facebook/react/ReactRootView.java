 ...
 * gesture).
 */
public class ReactRootView extends FrameLayout implements ReactZIndexedViewGroup, RootView, ReactRoot {
  ...
  public interface OnDetachListener {
    ...
    void onDetach(ReactRootView reactRootView,
        WeakReference<ReactInstanceManager> reactInstanceManagerWeakReference);
  }
  ...
  private int mAttachType = ReactRootViewTagGenerator.UNATTACHED;
  ...
  private @Nullable OnDetachListener mOnDetachListener;
  ...
  protected void onDetachedFromWindow() {
    ...
    if (mOnDetachListener != null) {
      mOnDetachListener.onDetach(this, new WeakReference<>(mReactInstanceManager));
    }
  }
  ...
  public void onViewAdded(View child) {
    ...
    if (mShouldLogContentAppeared) {
      ...
      if (mJSModuleName != null) {
        ...
        ReactMarker.directionalLogMarker(ReactMarkerConstants.CONTENT_APPEARED, mJSModuleName,
          mUniqueId);
      }
    }
  }
  ...
  @ThreadConfined(UI)
  public void initReactApplication(
    ReactInstanceManager reactInstanceManager,
    String moduleName,
    @Nullable Bundle initialProperties,
    @Nullable String initialUITemplate) {
    Systrace.beginSection(TRACE_TAG_REACT_JAVA_BRIDGE, "initReactApplication");
    try {
      UiThreadUtil.assertOnUiThread();
      Assertions.assertNotNull(reactInstanceManager);
      Assertions.assertCondition(
        reactInstanceManager.getCurrentReactContext() == null,
        "Must be called before createReactContext");
      Assertions.assertCondition(
        mReactInstanceManager == null,
        "This root view has already been attached to a catalyst instance manager");

      mInitApplication = true;
  ...
  public void startReactApplication(
    ...
    try {
      ...
      Assertions.assertCondition(
        mReactInstanceManager == null || mInitApplication,
        "This root view has already been attached to a catalyst instance manager");
      ...
      attachToReactInstanceManager(ReactRootViewTagGenerator.APP_ATTACH);
  ...
  public void unmountReactApplication() {
    ...
    mReactInstanceManager = null;
    mShouldLogContentAppeared = false;
    mAttachType = ReactRootViewTagGenerator.UNATTACHED;
  }
  ...
  public void removeOnDetachListener(OnDetachListener onDetachListener) {
    mOnDetachListener = null;
  }
  ...
  public void runFirstPage(ReactContext reactContext) {
    ...
    try {
      ...
      if (mUseSurface) {
        ...
        if (mWasMeasured) {
          UIManagerHelper.getUIManager(reactContext, getUIManagerType())
            .updateRootLayoutSpecs(getRootViewTag(), mWidthMeasureSpec, mHeightMeasureSpec);
        }

        CatalystInstance catalystInstance =
          Assertions.assertNotNull(reactContext).getCatalystInstance();
        TurboModuleManager turboModuleManager =
          (TurboModuleManager) catalystInstance.getJSIModule(JSIModuleType.TurboModuleManager);
        ...
        arguments.pushMap(appParams);

        mShouldLogContentAppeared = true;

        turboModuleManager.callFunction("runFirstPage", arguments);
      }
    } finally {
  ...
  public void runApplication() {
    ...
    ReactMarker.logMarker(ReactMarkerConstants.RUN_APPLICATION_START);
    try {
      if (mReactInstanceManager == null || !mIsAttachedToInstance) {
        return;
      }
      ...
      Systrace.endSection(TRACE_TAG_REACT_JAVA_BRIDGE);
      ReactMarker.logMarker(ReactMarkerConstants.RUN_APPLICATION_END);
    }
  }
  ...
  private void attachToReactInstanceManager(int type) {
    if (mIsAttachedToInstance && getAttachType() == ReactRootViewTagGenerator.FIRST_PAGE_ATTACH) {
      Assertions.assertNotNull(mReactInstanceManager);
      setAttachType(type);
      if (mReactInstanceManager.hasActiveContext()) {
        mReactInstanceManager.attachRootViewToInstance(this);
      }
    } else {
      attachToReactInstanceManager();
    }
  ...
  private class CustomGlobalLayoutListener implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private void checkForKeyboardEvents() {
      getDecorView().getWindowVisibleDisplayFrame(mVisibleViewArea);
