...
LOCAL_SHARED_LIBRARIES = libfb libfbjni reactmarker libfolly_json
...
# Header search path for all source files in this module.
LOCAL_C_INCLUDES := $(LOCAL_PATH)/ReactCommon $(REACT_NATIVE)/ReactCommon/jsi
...
LOCAL_STATIC_LIBRARIES = libcallinvokerholder libreactnativejni libreactperfloggerjni

# Compile all local c++ files
LOCAL_SRC_FILES := $(LOCAL_PATH)/ReactCommon/TurboModuleManager.cpp $(LOCAL_PATH)/ReactCommon/OnLoad.cpp $(LOCAL_PATH)/ReactCommon/JavaTurboModuleManagerDelegate.cpp
