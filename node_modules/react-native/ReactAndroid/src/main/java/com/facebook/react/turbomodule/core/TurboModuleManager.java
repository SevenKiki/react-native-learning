...
public class TurboModuleManager implements JSIModule, TurboModuleRegistry {
  ...
  public TurboModuleManager(
    ...
    mHybridData =
        initHybrid(
            ...
            delegate,
            false);
    if (ReactFeatureFlags.enableTurboModuleProfile) {
      TurboModulePerfLogger.setEnabled(true);
    }
    installJSIBindings();
  ...
  // TODO(liubojie): ensure callFunction is always behind loadFirstPage
  public native boolean callFunction(final String method, NativeArray arguments);
