...
public abstract class JSBundleLoader {
  ...
  public static JSBundleLoader createAssetLoader(
      final Context context, final String assetUrl, final String sourceUrl, final boolean loadSynchronously) {
    return new JSBundleLoader() {
      @Override
      public String loadScript(JSBundleLoaderDelegate delegate) {
        delegate.loadScriptFromAssets(context.getAssets(), assetUrl, sourceUrl, loadSynchronously);
        return assetUrl;
      }
    };
  }

  public static JSBundleLoader createAssetLoaderWithCacheKey(
      final Context context, final String assetUrl, final boolean loadSynchronously,
      final String cacheKey) {
    return new JSBundleLoader() {
      @Override
      public String loadScript(JSBundleLoaderDelegate delegate) {
        delegate.loadScriptFromAssets(context.getAssets(), assetUrl, loadSynchronously, cacheKey);
        return assetUrl;
      }
    };
  }
  ...
  public static JSBundleLoader createFileLoader(
    ...
    return new JSBundleLoader() {
      @Override
      public String loadScript(JSBundleLoaderDelegate delegate) {
        delegate.loadScriptFromFile(fileName, assetUrl, loadSynchronously, cacheKey);
        return fileName;
      }
    };
  }
