...
public class KdsScrollViewManager extends ReactScrollViewManager {
  ...
  @Override
  public KdsScrollView createViewInstance(ThemedReactContext context) {
    return new KdsScrollView(context, mFpsListener);
  }
  ...
  public void setBorderRadius(KdsScrollView view, int index, float borderRadius) {
  ...
  public void setBorderStyle(KdsScrollView view, @Nullable String borderStyle) {
  ...
  @ReactPropGroup(
    ...
    defaultFloat = YogaConstants.UNDEFINED)
  public void setBorderWidth(KdsScrollView view, int index, float width) {
  ...
  protected void onAfterUpdateTransaction(
    @NonNull ReactScrollView view) {
    super.onAfterUpdateTransaction(view);
    if (view instanceof KdsScrollView) {
      KdsScrollView kdsView = (KdsScrollView) view;
      // transform
