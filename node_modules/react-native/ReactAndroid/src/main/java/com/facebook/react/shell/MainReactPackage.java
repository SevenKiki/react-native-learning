...
public class MainReactPackage extends TurboReactPackage {
  ...
  public List<ViewManager> createViewManagers(ReactApplicationContext reactContext) {
    ...
    viewManagers.add(new ReactHorizontalScrollViewManager(reactContext.getFpsListener()));
    viewManagers.add(new ReactHorizontalScrollContainerViewManager());
    viewManagers.add(new ReactProgressBarViewManager());
    viewManagers.add(new ReactScrollViewManager(reactContext.getFpsListener()));
    ...
    viewManagers.add(new KdsViewManager());
    viewManagers.add(new KdsScrollViewManager(reactContext.getFpsListener()));
    viewManagers.add(new KdsHorizontalScrollViewManager(reactContext.getFpsListener()));
    viewManagers.add(new BackgroundReactImageManager());
  ...
  protected List<ModuleSpec> getViewManagers(ReactApplicationContext reactContext) {
    Systrace.beginSection(Systrace.TRACE_TAG_REACT_VIEW, "getViewManagersArray");
    ArrayList<ModuleSpec> moduleSpecs = new ArrayList<>();
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ARTRenderableViewManager::createARTGroupViewManager, "ARTGroup"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ARTRenderableViewManager::createARTShapeViewManager, "ARTShape"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ARTRenderableViewManager::createARTTextViewManager, "ARTText"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactCheckBoxManager::new, "AndroidCheckBox"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactDialogPickerManager::new, "AndroidDialogPicker"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactDrawerLayoutManager::new, "AndroidDrawerLayout"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactDropdownPickerManager::new, "AndroidDropdownPicker"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactHorizontalScrollViewManager::new, "AndroidHorizontalScrollView"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactHorizontalScrollContainerViewManager::new, "AndroidHorizontalScrollContentView"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactProgressBarViewManager::new, "AndroidProgressBar"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactScrollViewManager::new, "RCTScrollView"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactSliderManager::new, "RCTSlider"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactSwitchManager::new, "AndroidSwitch"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(SwipeRefreshLayoutManager::new, "AndroidSwipeRefreshLayout"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ARTSurfaceViewManager::new, "ARTSurfaceView"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(FrescoBasedReactTextInlineImageViewManager::new, "RCTTextInlineImage"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactImageManager::new, "RCTImageView"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactModalHostManager::new, "RCTModalHostView"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactRawTextManager::new, "RCTRawText"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactTextInputManager::new, "AndroidTextInput"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactTextViewManager::new, "RCTText"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactViewManager::new, "RCTView"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactRawTextManager::new, "AndroidViewPager"));
    moduleSpecs.add(ModuleSpec.viewManagerSpec(ReactVirtualTextViewManager::new, "RCTVirtualText"));
