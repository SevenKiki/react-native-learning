...
import com.facebook.react.packagerconnection.TraceHandler;
import java.io.File;
...
public class DevServerHelper {
  ...
  private @Nullable
  JSPackagerClient mPackagerClient;
  private @Nullable
  InspectorPackagerConnection mInspectorPackagerConnection;
  ...
  public void openPackagerConnection(
    ...
    new AsyncTask<Void, Void, Void>() {
      ...
      protected Void doInBackground(Void... backgroundParams) {
        ...
        handlers.put(
            TraceHandler.TRACE_TAG, new TraceHandler(reactInstanceManagerDevHelper));
