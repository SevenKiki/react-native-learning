...
afterEvaluate { project ->
    ...
    ext.snapshotMavenUrl = 'http://nexus.corp.kuaishou.com:88/nexus/content/repositories/snapshots/'
    def base = "${AAR_OUTPUT_PATH}/com/kwai/react/react-native/${VERSION_NAME}/"
    def prefix = "react-native-${VERSION_NAME}"
    ext.pomFile = "${base}/${prefix}.pom"
    ext.uploadFile = "${base}/${prefix}.aar"
    ext.sourcesFile = "${base}/${prefix}-sources.jar"
//    ext.javadocFile = "${project.buildDir.getPath()}/libs/${project.name}-javadoc.jar" // 部分javadoc格式不兼容
    ext.packaging = "aar"
    task mavenUpload {
        doLast {
            exec {
...
//                        "-Djavadoc=" + javadocFile,
    ...
    task installArchives(type: Upload) {
        ...
        repositories.mavenDeployer {
            ...
            repository(url: "file://${projectDir}/" + AAR_OUTPUT_PATH)

            configureReactNativePom(pom)
        }
    }

    mavenUpload.dependsOn installArchives
}
