...
let turboUIManager = null;
if (global.nativeModuleProxy) {
  if (global.__turboModuleProxy) {
    NativeModules = new Proxy({}, {
      get(target, name) {
        if (name === 'setTurboUIManager') {
          return (uimanager) => {
            turboUIManager = uimanager;
         };
        } else if (global.__turboModuleProxy && name === 'UIManager' && turboUIManager) {
          return turboUIManager;
        }
