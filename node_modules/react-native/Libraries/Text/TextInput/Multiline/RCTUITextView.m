...
- (void)setDefaultTextAttributes:(NSDictionary<NSAttributedStringKey, id> *)defaultTextAttributes
{
  ...
  [self _updatePlaceholder];
  [self _updateExistText];
}

- (void)_updateExistText {
  if (_defaultTextAttributes) {
    NSString *safeStr = self.attributedText.string ? self.attributedText.string : @"";
    self.attributedText = [[NSAttributedString alloc] initWithString:safeStr attributes:_defaultTextAttributes];
  }
}
