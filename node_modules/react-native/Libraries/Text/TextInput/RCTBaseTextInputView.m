...
NSString * const RCTNotificationTextInputNeedDelayStateChange = @"RCTNotificationTextInputNeedDelayStateChange";

static BOOL RCTTextInputNeedDelay = NO;

void RCTSetTextInputNeedDelay(BOOL needDelay) {
  if (RCTTextInputNeedDelay != needDelay) {
    RCTTextInputNeedDelay = needDelay;
    [[NSNotificationCenter defaultCenter] postNotificationName:RCTNotificationTextInputNeedDelayStateChange object:nil];
  }
}
...
- (instancetype)initWithBridge:(RCTBridge *)bridge
{
  ...
  if (self = [super initWithFrame:CGRectZero]) {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onNotificationNeedDelayStateChange:) name:RCTNotificationTextInputNeedDelayStateChange object:nil];
  }
...
- (void)onNotificationNeedDelayStateChange:(NSNotification *)noti {
  if (!RCTTextInputNeedDelay && _needFocus) {
    [self reactFocus];
  }
}
