...
NativeToJsBridge::NativeToJsBridge(
    ...
    : m_destroyed(std::make_shared<bool>(false)),
      ...
      m_executor(jsExecutorFactory->createJSExecutor(m_delegate, jsQueue, uniqueId)),
