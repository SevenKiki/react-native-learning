...
struct InstanceCallback {
  ...
  virtual bool useCodeCache() {
    return false;
  };
  virtual jsi::CodeCacheItem getValidatedCodeCache(int hash) {
    return jsi::CodeCacheItem();
  };
  virtual void updateCodeCache(int hash, jsi::CodeCacheItem& codeCacheItem){};
};
...
class RN_EXPORT Instance {
 public:
  ...
  void loadScriptFromStringWithKey(
      std::unique_ptr<const JSBigString> string,
      std::string sourceURL,
      bool loadSynchronously,
      std::string &hash);
 ...
 private:
  ...
  class JSCallInvoker : public CallInvoker {
   ...
   public:
    ...
    void invokeAsyncBridgeless(std::function<void()> &&func) override;
