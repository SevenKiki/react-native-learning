...
class JSI_EXPORT TurboModule : public facebook::jsi::HostObject {
 public:
  using MethodInvokerType = facebook::jsi::Value (facebook::jsi::Runtime &rt, TurboModule &turboModule, const facebook::jsi::Value *args, size_t count);
  ...
  struct MethodMetadata {
    size_t argCount;
    std::function<MethodInvokerType> invoker;
  };
