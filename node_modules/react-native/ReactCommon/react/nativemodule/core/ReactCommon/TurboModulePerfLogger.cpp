...
//  g_enabled = enabled;
//  if (g_enabled) {
//    ReactMarker::logTMMMarker = JReactMarker::logTMMMarker;
//  } else {
//    ReactMarker::logTMMMarker = nullptr;
//  }
//}
...
//  MARK_TMM(moduleName, nullptr, id);
//  if (logger != nullptr) {
...
//  NativeModulePerfLogger *logger = g_perfLogger.get();
//  MARK_TMM(moduleName, methodName, 0);
//  if (logger != nullptr) {
...
void asyncMethodCallExecutionStart(
    ...
    int32_t id) {
//  NativeModulePerfLogger *logger = g_perfLogger.get();
//  MARK_TMM(moduleName, methodName, id);
//  if (logger != nullptr) {
