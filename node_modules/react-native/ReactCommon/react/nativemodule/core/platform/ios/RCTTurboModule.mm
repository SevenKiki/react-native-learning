...
BOOL RCTShouldEnableTurboModuleForClass(Class moduleClass)
{
  // 禁用Core里的Module走turboModule，待turboModule稳定后可移除此逻辑
  return RCTTurboModuleEnabled() &&
  [moduleClass conformsToProtocol:@protocol(RCTTurboModule)] &&
  [moduleClass respondsToSelector:@selector(isCustomModule)] &&
  [moduleClass isCustomModule];
}
