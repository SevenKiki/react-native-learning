...
import { NativeModules, Dimensions, PixelRatio, Linking, Platform, StatusBar } from 'react-native';
...
function getAppVersion() {
  ...
  var _ref = ((_NativeModules$KRNBas = NativeModules.KRNBasic) === null || _NativeModules$KRNBas === void 0 ? void 0 : (_NativeModules$KRNBas2 = _NativeModules$KRNBas.getDeviceInfoSync) === null || _NativeModules$KRNBas2 === void 0 ? void 0 : _NativeModules$KRNBas2.call(_NativeModules$KRNBas)) || {
    data: {
      appVersion: ""
    }
  },
...
var env = NativeModules.KSRCTBridge.getEnvSync();
...
function screenSize(size) {
  ...
  var physicalPixels = size * PixelRatio.getPixelSizeForLayoutSize(DeviceWidth) / designW;
...
var useFmpLog = function useFmpLog(rootTag, onCreateTimestamp, extra) {
  useEffect(function () {
    ...
    NativeModules === null || NativeModules === void 0 ? void 0 : (_NativeModules$RootVi = NativeModules.RootViewPageBridge) === null || _NativeModules$RootVi === void 0 ? void 0 : _NativeModules$RootVi.rootViewDidMountWith(rootTag, {});
  }, [rootTag]);
  var t2 = useRef(0);
  var t3 = useRef(0);
  var handleT2 = useCallback(function () {
    if (t2.current) {
      return;
    }
  ...
  var handleT3 = useCallback(function () {
    if (t3.current) {
      return;
    }
    ...
    if (t2.current > 0 && t3.current > 0 && t3.current >= t2.current) {
      ...
      NativeModules === null || NativeModules === void 0 ? void 0 : (_NativeModules$RootVi2 = NativeModules.RootViewPageBridge) === null || _NativeModules$RootVi2 === void 0 ? void 0 : _NativeModules$RootVi2.reportPageRenderTime(rootTag, t2.current, t3.current, extra);
    }
...
var makePhoneCall = (function (phoneArr) {
  ...
  return invoke("ui.showBottomSheet", {
    ...
    var tel = res.value;
    Linking.canOpenURL(tel).then(function (supported) {
      if (!supported) {
...
var requestLocation = /*#__PURE__*/(function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(biz, statKey) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return invoke("system.requestLocation", {
              biz: biz,
              statKey: statKey
            });
...
var getAppInfo = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
  var result;
  return _regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return invoke("system.getAppInfo", {});
...
function isIphoneX() {
  return Platform.OS === "ios" && !Platform.isPad && !Platform.isTV && (checkDemension(780) || checkDemension(812) || checkDemension(844) || checkDemension(896) || checkDemension(926) || checkDemension(852) || checkDemension(932));
}
...
var safeAreaTop = Platform.select({
...
export { appVersion$1 as appVersion, bridge, index as default, env$1 as env, format, formatHotPeople, hooks, iphone, screenUnit, urlSplicing };
