...
class Plugin {
    ...
    importMethod(methodName, file, pluginState, isDefaultImport) {
        if (!pluginState.selectedMethods[methodName]) {
            ...
            const path = winPath(this.customName
                ? this.customName(transformedMethodName, file, isDefaultImport)
                : (0, path_1.join)(this.libraryName, libraryDirectory, transformedMethodName, this.fileName));
    ...
    CallExpression(path, state) {
        ...
        node.arguments = node.arguments.map(arg => {
            ...
            if (pluginState.specified[argName] &&
                ...
                return this.importMethod(pluginState.specified[argName], file, pluginState, true);
            }
            return arg;
        });
    }
