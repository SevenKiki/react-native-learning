export default class Plugin {
    constructor(libraryName: any, libraryDirectory: any, style: any, styleLibraryDirectory: any, customStyleName: any, camel2DashComponentName: any, camel2UnderlineComponentName: any, fileName: any, customName: any, transformToDefaultImport: any, types: any, index?: number);
    getPluginState(state: any): any;
    importMethod(methodName: any, file: any, pluginState: any, isDefaultImport: any): any;
    ...
    SwitchStatement(path: any, state: any): void;
    SwitchCase(path: any, state: any): void;
    ClassDeclaration(path: any, state: any): void;
}
