...
export const delay = timeout => new Promise(resolve => setTimeout(resolve, timeout)); // 加工处理reject的errorInfo，在10.1.10版本之前，IOS并未传递code 只能通过msg解析
...
export const normalParams = params => {
  if (__DEV__ && !globalConfig.rootTag && (!params || typeof params === 'object' && !('rootTag' in params))) {
  ...
  if (typeof params === 'object' && !('rootTag' in params) && globalConfig.rootTag != null) {
    params.rootTag = globalConfig.rootTag;
  }

  return JSON.stringify(params);
};
export const normalNamespace = name => {
...
export function versionCompare(current, other) {
...
export function getAppVersion() {
  ...
  } = ((_NativeModules$KRNBas = NativeModules.KRNBasic) === null || _NativeModules$KRNBas === void 0 ? void 0 : (_NativeModules$KRNBas2 = _NativeModules$KRNBas.getDeviceInfoSync) === null || _NativeModules$KRNBas2 === void 0 ? void 0 : _NativeModules$KRNBas2.call(_NativeModules$KRNBas)) || {
    data: {
      appVersion: ''
    }
  };
