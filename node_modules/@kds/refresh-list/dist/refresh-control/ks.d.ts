...
import { LoadingType } from './loading/ks';
...
export default function getKsRefreshControl(type?: LoadingType): {
    new (props: KsRefreshControlProps): {
        setRefreshControlParams(refreshControlParams: RefreshControlParams): void;
        render(): JSX.Element;
        context: any;
        setState<K extends "animated" | "percent">(state: KsRefreshControlPropsState | ((prevState: Readonly<KsRefreshControlPropsState>, props: Readonly<KsRefreshControlProps>) => KsRefreshControlPropsState | Pick<KsRefreshControlPropsState, K> | null) | Pick<KsRefreshControlPropsState, K> | null, callback?: (() => void) | undefined): void;
