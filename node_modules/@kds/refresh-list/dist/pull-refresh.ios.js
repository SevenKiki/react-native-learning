...
import { DefaultRefreshControl, PullState, } from './constant';
export default class PullRefresh extends Component {
    constructor(props) {
        super(props);
        this.pullAnimHeight = 0;
        this.minPullDistance = 0;
        this.onLayout = (evt) => {
        ...
        this.scrollContent = () => React.Children.map(this.props.children, (child) => React.cloneElement(child, {
        ...
        const canMove = (name, evt, gestureState) => {
        ...
        this.panResponder = PanResponder.create({
            onStartShouldSetPanResponder: canMove.bind(this, 'onStartShouldSetPanResponder'),
            onStartShouldSetPanResponderCapture: canMove.bind(this, 'onStartShouldSetPanResponderCapture'),
            onMoveShouldSetPanResponder: canMove.bind(this, 'onMoveShouldSetPanResponder'),
            onMoveShouldSetPanResponderCapture: canMove.bind(this, 'onMoveShouldSetPanResponderCapture'),
            onPanResponderGrant: () => {
    ...
    render() {
        ...
        const content = this.props.isContentScroll !== false ? (<Animated.View style={{
            transform: [{ translateY: this.pan }],
            flex: 1,
        }}>
          {this.scrollContent()}
        </Animated.View>) : (this.scrollContent());
        const RefreshControl = this.props.RefreshControl;
        return (<View style={[styles.container, this.props.refreshLayoutStyle]} {...this.panResponder.panHandlers}>
        <Animated.View onLayout={this.onLayout} style={[
            styles.freshItem,
            {
                top: top,
