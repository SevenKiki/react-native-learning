...
With Expo, you'll need to run `expo install @kds/react-native-svg` to install this library.
...
2. Link native code
   ...
   ```bash
   react-native link @kds/react-native-svg
   ```
...
1. `yarn add @kds/react-native-svg` In RN 0.60+, this is all you should ever need to do get Android working. Before this, react-native link was responsible for the following steps:

2. Append the following lines to `android/settings.gradle`:

   ```gradle
   include ':@kds/react-native-svg'
   project(':@kds/react-native-svg').projectDir = new File(rootProject.projectDir, '../node_modules/@kds/react-native-svg/android')
   ```

3. Insert the following lines inside the dependencies block in `android/app/build.gradle`:

   ```gradle
   implementation project(':@kds/react-native-svg')
   ```
...
1. Open your project in XCode and drag the `RNSVG.xcodeproj` file (located in `.../node_modules/@kds/react-native-svg/ios`) into the Libraries directory shown in XCode.
...
```ruby
pod 'RNSVG', :path => '../node_modules/@kds/react-native-svg'
```
...
import Svg, {
  ...
  Pattern,
  Mask,
} from '@kds/react-native-svg';

/* Use this if you are using Expo
import * as Svg from '@kds/react-native-svg';
...
import { SvgUri } from '@kds/react-native-svg';
...
```jsx
import * as React from 'react';
import { SvgCssUri } from '@kds/react-native-svg';
...
```jsx
import * as React from 'react';
import { SvgXml } from '@kds/react-native-svg';
...
```jsx
import * as React from 'react';
import { SvgCss } from '@kds/react-native-svg';
...
import { Svg, Rect } from '@kds/react-native-svg';
