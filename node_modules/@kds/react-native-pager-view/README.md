...
`"@react-native-community/viewpager"` library has been changed to `@kds/react-native-pager-view`. Here you can find more information, how to migrate pager view to the latest [version](https://github.com/callstack/react-native-pager-view/blob/master/MIGRATION.md) 
## Getting started

`yarn add @kds/react-native-pager-view`
...
`react-native link @kds/react-native-pager-view`
...
```ruby
pod 'react-native-pager-view', :path => '../node_modules/@kds/react-native-pager-view'
```
...
project(':react-native-pager-view').projectDir = new File(rootProject.projectDir, '../node_modules/@kds/react-native-pager-view/android')
```
...
import PagerView from '@kds/react-native-pager-view';
