export declare type SuccessParams<T> = {
    /**
     * 响应的 header 头
...
export declare type FailParams = {
    /**
     * 请求错误码
     * @type {number}
     */
...
export declare type SuccessHander<T> = (params: SuccessParams<T>) => void;
export declare type FailHander = (params: FailParams) => void;
export declare type RequestOptions<P> = {
    /**
...
export declare type ExportRequestOptions<R, P> = RequestOptions<P> & {
    /**
     ...
     */
    requestInterceptors?: Array<(options: ExportRequestOptions<R, P>) => ExportRequestOptions<R, P>>;
    /**
     * 响应拦截器
     * @type {Array<(options: SuccessParams<R>) => SuccessParams<any>>}
     */
    responseInterceptors?: Array<(response: SuccessParams<R>) => SuccessParams<any>>;
};
