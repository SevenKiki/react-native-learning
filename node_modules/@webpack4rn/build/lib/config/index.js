...
const config = (webpackConfig, options = {}) => {
    return (env) => {
        ...
        config.module
            ...
            .test(plugins_1.AssetResolver.DEFAULT_TEST)
            .use('babel')
        ...
        config.module
            ...
            .options(Object.assign({ cacheDirectory: false }, fs.existsSync(webpackBabelConfigPath) ? {
        ...
        config.plugin('asset').use(plugins_1.AssetResolverPlugin, [
            {
                platform: env.platform,
            },
        ]);
        ...
        config.plugin('guarded').use(plugins_1.GuardedLoadModulePlugin, []);
        config.plugin('restoreEnv').use(plugins_1.RestoreEnvPlugin, [
            {
